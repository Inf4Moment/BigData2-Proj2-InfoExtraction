...
class NERTagger(object):
    ...
    def construct_entity_list(self, words, post_tags, ner_tags):
        ...
        '''
        命名实体识别输出格式
            位置标签（B,I,E,S,O）-实体类型标签（Nh,Ns,Ni）/*O后不跟-符号*/
...
if __name__ == "__main__":
    text = " 2011 年 7 月 12 日（“首次增持日”）首次通过上海证券交易所（“上交所”）交易系统以买入方式增持本公司 A 股股份4106999股（“首次增持”）"
    ...
    ner_tagger = NERTagger("D:/pyltp/ltp_data", "../config/ner_com_blacklist.txt")

    res = ner_tagger.ner(text, {})
